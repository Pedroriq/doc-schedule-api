...
export class AppointmentController {
    ...
    static async getAppointmentByPacientId(req: Request, res: Response) {
        ...
        try {
            ...
            console.error(error)
            res.status(500).json({message: "Error to search appoitment by patient id"})
        }        
    }
    ...
    static async getAppointmentByDoctorId(req: Request, res: Response) {
        ...
        try {
            ...
            console.error(error)
            res.status(500).json({message: "Error to search appoitment by doctor id"})
        }        
    }
    ...
    static async getTodayAppointment(req: Request, res: Response){
        ...
        try { 
            const todayAppointments = repo.find({where: {date: Between(startOfDay, endOfDay)},
            relations: ['patient', 'doctor']
            })
            ...
            res.status(500).json({message: "Error to search today appointment", error: error})
        }
